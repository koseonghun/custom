...
public class UserVO {
	...
	public int custom_user_seq;
	public String custom_user_name;
	public String custom_user_nick;
	public String custom_user_email;
	public String custom_user_pswd;
	public String custom_user_birth;
	public String custom_user_phone;
    public String custom_user_address;
    public String custom_user_auth;
    public String custom_user_del_yn;
    public Date custom_user_reg_date;
    public Date custom_user_mod_date;
